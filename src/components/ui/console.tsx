export default function Console() {
  return (
    <div className="mx-6 lg:ml-[2rem] max-w-[35rem] md:w-full h-[20rem] md:h-[15rem] bg-[#1a1a1a] rounded-[1rem] overflow-hidden flex flex-col shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
