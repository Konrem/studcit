export default function Console() {
  return (
    <div className="max-w-[35rem] mx-6 sm:mx-0 md:w-full h-[20rem] md:h-[15rem] bg-[#1a1a1a] rounded-xl overflow-hidden flex flex-col shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
