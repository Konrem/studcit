...
export default function Browser() {
  return (
    <div className="relative flex mx-6 sm:m-0 h-[500px] sm:h-[400px] max-w-[35rem] w-full flex-col overflow-hidden rounded bg-neutral-300 shadow-[5px_5px_10px_rgba(31,31,31,0.245)]">
      <div>
