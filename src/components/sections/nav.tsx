...
export default function Header() {
  ...
  return (
    <nav className="fixed w-full z-20 dark-theme border-b-1 border-neutral-700" role="navigation">
      <div className="container flex item-center flex-wrap justify-between px-2 lg:px-4 mx-auto flex-row" >
